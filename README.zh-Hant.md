...
- 使用三段式建議結構：安全起點、先注意的風險、如果不對先調什麼
- 針對手機、手機 Pro、APS-C、全幅和運動相機使用不同操作語言
- 設計原則記錄於 [docs/shooting-advice-design.md](docs/shooting-advice-design.md)
...
### Copy AI Prompt
- 根據目前光線、天氣、地點、拍攝類型、器材、經驗等級和本地建議產生 prompt
- 使用者可一鍵複製到外部 AI 工具，不需要 Luma 接入付費 AI API
- Prompt 功能應重用本地建議上下文，而不是重新維護另一套邏輯
